...
import hydrozoa.config.HeadConfig.Fields.HasTxTiming
import hydrozoa.lib.cardano.scalus.QuantizedTime.QuantizedInstant
import hydrozoa.multisig.ledger.dapp.tx
import hydrozoa.multisig.ledger.dapp.tx.{FallbackTx, RolloutTx, SettlementTx, TxTiming}
...
object SettlementTxSeq {
    type Config = FallbackTx.Config & HasTxTiming
                ...
                case None =>
                    for {
                        settlementTx <- SettlementTx.Builder
                            .NoPayouts(config)
                            .build(args.toArgsNoPayouts(txTiming = config.txTiming))
                            .left
