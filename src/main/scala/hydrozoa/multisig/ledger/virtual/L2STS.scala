...
/** This module defines the "L2 STS". It is almost a direct clone of scalus's upstream "STS" (state
  ...
  * scalus ledger rules.
  *
  * ///// Where possible, we use the upstream types for representing our own STS. This means that
  * our State, Context, and Transition types are "too big" -- for instance, our State type contains
