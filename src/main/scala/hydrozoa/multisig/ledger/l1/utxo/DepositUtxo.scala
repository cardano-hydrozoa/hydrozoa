...
/** @param l2Payload
  ...
  *   deposit tx metadata must carry this payload's blake2b_256 hash (docs/spec/l2-isomorphism.md).
  *   This includes ONLY the part relevant to L2, and not the hydrozoa/cardano/L1-specific stuff.
  */
