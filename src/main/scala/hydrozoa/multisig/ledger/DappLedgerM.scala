...
import hydrozoa.config.HeadConfig.Fields.{HasEquityShares, HasTallyFeeAllowance, HasTxTiming, HasVotingDuration}
...
private type RT[A] = ReaderT[S, ledger.DappLedgerM.Config, A]
...
object DappLedgerM {
    ...
    type Config =
        HasEquityShares & HasTxTiming & HasTallyFeeAllowance & HasVotingDuration &
            FinalizationTxSeq.Config & DepositTx.Config
