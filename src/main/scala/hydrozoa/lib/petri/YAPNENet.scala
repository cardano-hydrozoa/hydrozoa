...
//  */
//
//type YAPNEPlace = Place.Topology & Place.Semantics & Place.Instantiation  & Place.Presentation
//type YAPNEArc = Arc.Topology[String, String] & Arc.Semantics.Reset[YAPNEPlace]
//
//
...
////                      "label" -> arc.label.asJson
////                    )
////                case i: Arc.Semantics.Inhibitor.type =>
////                    Json.obj(
////                      "id" -> arcId.asJson,
////                      "source" -> arc.arcPlaceId.asJson,
////                      "target" -> arc.arcTransitionId.asJson,
...
////                      "label" -> arc.label.asJson
////                    )
////                case reset: Arc.Semantics.Reset.type =>
////                    Json.obj(
////                      "id" -> arcId.asJson,
////                      "source" -> arc.arcPlaceId.asJson,
////                      "target" -> arc.arcTransitionId.asJson,
...
////          arcPlaceId = "p_0",
////          arcTransitionId = "t_0",
//////          semantics = Arc.Semantics.Read(NonNegativeInt.unsafeApply(1)),
