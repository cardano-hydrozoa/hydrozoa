...
import hydrozoa.l2.commitment.{TrustedSetup, infG1Point, infG2Point}
...
def getG1Commitment(
    ...
    subsetInG1.foldLeft(zero.dup()): (a, b) =>
        a.add(b)
}
