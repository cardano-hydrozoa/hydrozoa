...
//import hydrozoa.*
//import hydrozoa.config.{CollectiveContingencyDepositsSection, ContingencyDepositsAndEquityShares}
...
//def genEquityShares(peers: NonEmptyList[TestPeer]): Gen[ContingencyDepositsAndEquityShares] =
//    for {
//        addresses <- Gen.listOfN(peers.length, genPubkeyAddress(testNetwork))
//        shares <- genShares(peers.length)
//    } yield {
//        val peerConfigs = addresses.zip(shares).zipWithIndex.map { case ((addr, share), index) =>
//            import spire.math.UByte
//            UByte(index) -> hydrozoa.config.PeerConfig(
//                payoutAddress = Address[L1](addr),
//                // TODO: add generators
//                collateralDeposit = Coin(6_000_000), // Above minimum of 5_000_000
//                // TODO: add generators
//                voteDeposit = Coin(4_000_000), // Above minimum of 3_000_000
//                equityShare = share
//            )
//        }.toMap
//        
...
//        )
//        ContingencyDepositsAndEquityShares.apply(validCollectiveDeposits, peerConfigs).toOption.get
//    }
//
