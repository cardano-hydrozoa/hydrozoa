...
import hydrozoa.{L1, Output, OutputL1, UtxoIdL1}
...
def yaciTestSauceGenesis(network: Network): Set[(UtxoIdL1, OutputL1)] =
    ...
    List(
      ...
      (
        ...
        (
          ...
          Output[L1](
            TransactionOutput
                .apply(address = address, value = Value.lovelace(10_000_000_000L))
