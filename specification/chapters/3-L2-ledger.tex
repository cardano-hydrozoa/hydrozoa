...
\begin{description}
    ...
    \item[No collateral on L2.]
      ...
      However, in Hydrozoa's unanimous consensus protocol, any peer can deny service simply by stopping its responses to L2 messages. Furthermore, a peer can disconnect from the source of too many transactions failing phase-2 validation, mitigating the incurred resource costs.
