...
\begin{equation*}
  ...
  \end{array}\right\}
\end{equation*}
These L2 utxos uniquely correspond to the L1 \code{absorbedDeposits} of the major block:
\begin{description}
  \item[output reference:]~
    \begin{description}
      \item[id.] The Blake2b-256 hash (\codeMath{\mathcal{H}_{32}}) of \code{absorbedDeposits}. Incidentally, this is also the genesis event's unique ID (\code{TxId}).
