...
\begin{enumerate}
  ...
  \item Let \code{disputeId} be the CIP-67 prefix for 8683 concatenated with the Blake2b-224 hash (\codeMath{\mathcal{H}_{28}}) of the \code{multisigTreasury} output reference.
