...
On receiving an \code{AckInit}, the receiving peer must verify that \code{signature} is a valid signature of the intialization transaction by the sender's verification key.
