...
These new utxos correspond to the deposits absorbed by the settlement transaction (\cref{h:multisig-settle}) of the major L2 block, with the \codeMathTt{Output^{L2}} fields of each new utxo set as follows:
\begin{description}
