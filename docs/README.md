...
| [l2-isomorphism.md](l2-isomorphism.md) | L2 isomorphism: driving the EUTXO ledger with native Cardano txs — the headId pin, mandatory tx metadata, screening vs submission, deposit authentication (COSE), and the `cardano-eutxo` / `any-remote` backend selection. |
